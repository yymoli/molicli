                ...
                <div className="um-row">
                    ...
                    <div className="um-lg-4 um-md-4 um-sm-6 um-xs-12">
                        <div className="um-list-item-inner">
                            ...
                            <div className="um-list-item-right">
                                <input type="text" disabled={metaData&&metaData.com&&metaData.com.mobile&&metaData.com.mobile.disabled} style={metaData&&metaData.com&&metaData.com.mobile&&metaData.com.mobile.style} className="form-control" value={data.phone}  onChange={(e)=>this.handleChange("mobile",e)}/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="um-lg-4 um-md-4 um-sm-6 um-xs-12">
                        <div className="um-list-item-inner">
                            ...
                            <div className="um-list-item-right">
                                <input type="text" disabled={metaData&&metaData.com&&metaData.com.companyName&&metaData.com.companyName.disabled} style={metaData&&metaData.com&&metaData.com.companyName&&metaData.com.companyName.style} className="form-control" value={data.departmentName}  onChange={(e)=>this.handleChange("companyName",e)}/>
                            </div>
                        </div>
                    </div>
                </div>
